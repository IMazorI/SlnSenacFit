...
create procedure ps_BuscarCliente
@nomeUsu varchar(30)
as
...
drop procedure ps_ListaUsuarios
...
--)
--as
--	select idUsuario, nomeUsu, perfilUsu, telefoneUsu from Usuario where nomeUsu LIKE @nomeUsu + '%'


28/11/22

drop procedure ps_BuscarCliente
